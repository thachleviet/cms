...
function MenuEditor(idSelector, options) {
    ...
    function editItem($item) {
        ...
        $.each(data, function (p, v) {
            console.log(p+'===', v);
            if(p ==='image'){
                $form.find('input[type=file]').attr('value',v)
            }else{
    ...
    function TButton(attr) {
        return $("<a>").addClass(attr.classCss).addClass('clickable').attr("href", "#").html(attr.category_name);
    }

    function TButtonGroup() {
        var $divbtn  = $('<div>').addClass('btn-group pull-right');
        var $btnEdit = TButton({classCss: 'btn btn-primary btn-xs btnEdit', category_name: settings.labelEdit});
        var $btnRemv = TButton({classCss: 'btn btn-danger btn-xs btnRemove', category_name: settings.labelRemove});
        var $btnUp   = TButton({classCss: 'btn btn-default btn-xs btnUp btnMove', tecategory_namext: '<i class="glyphicon glyphicon-chevron-up clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-default btn-xs btnDown btnMove', category_name: '<i class="glyphicon glyphicon-chevron-down clickable"></i>'});
        var $btnOut  = TButton({classCss: 'btn btn-default btn-xs btnOut btnMove', category_name: '<i class="glyphicon glyphicon-save clickable"></i>'});
        var $btnIn   = TButton({classCss: 'btn btn-default btn-xs btnIn btnMove', category_name: '<i class="glyphicon glyphicon-export clickable"></i>'});
    ...
    function createMenu(arrayItem, depth) {
        ...
        $.each(arrayItem, function (k, v) {
            ...
            var $span = $('<span>').addClass('txt').append(v.category_name);
    ...
    this.add = function(){
        ...
        $form.find('.item-menu').each(function(){
            ...
            if($(this).attr('name') === 'image'){
                data[$(this).attr('name')] = $(this).val().replace("C:\\fakepath\\", "");
            }
        });

        var btnGroup = TButtonGroup();
        var textItem = $('<span>').addClass('txt').text(data.category_name);
