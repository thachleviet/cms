...
<div class="login-box">
    ...
    <div class="login-box-body">
        @if (session('message_login'))
            <div class="alert alert-warning">{{session('message_login')}}</div>
        @endif
...
<!-- jQuery 3 -->
<script src="{{asset('backend/bower_components/jquery/dist/jquery.min.js?v='.time())}}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{asset('backend/bower_components/bootstrap/dist/js/bootstrap.min.js?v='.time())}}"></script>
<!-- iCheck -->
<script src="{{asset('backend/plugins/iCheck/icheck.min.js?v='.time())}}"></script>
<script>
    $(function () {
        $('input').iCheck({
