                            ...
                            <div class="content-tap" style="padding-top: 20px">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$_object['staff_first_name']}}" class="form-control"  id="staff_first_name" name="staff_first_name"  placeholder="Enter first name">
                                        <small  class="form-text text-muted"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="staff_last_name">Last Name <span style="color: red"> * </span></label>
                                        <input type="text" value="{{$_object['staff_last_name']}}" class="form-control" name="staff_last_name"  placeholder="Enter last name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$_object['staff_email']}}" class="form-control" name="staff_email"  placeholder="Enter email">
                                        <small id="staff_email" class="form-text text-muted"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="staff_phone">Phone <span style="color: red"> * </span></label>
                                        <input type="text" value="{{$_object['staff_phone']}}" class="form-control" name="staff_phone" placeholder="Enter phone">
                                    </div>
                                </div>
                            </div>
                        </section>
                            ...
                            <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <div class="label-check col-sm-12">
                                                <div class=" col-sm-3" >
                                                    <input type="radio" name="staff_gender" id="radio1_Opt1" value="male" @if($_object['staff_gender'] == 'male') {{'checked'}} @endif >
                                                    <label for="radio1_Opt1">Nam</label>
                                                </div>
                                                <div class=" col-sm-3">
                                                    <input type="radio" name="staff_gender" id="radio1_Opt2" value="female" @if($_object['staff_gender'] == 'female') {{'checked'}} @endif >
                                                    <label for="radio1_Opt2">Nữ</label>
                                                </div>
                                                <div class=" col-sm-3">
                                                    <input type="radio" name="staff_gender" id="radio1_Opt3" value="other" @if($_object['staff_gender'] == 'other') {{'checked'}} @endif>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group date" data-provide="datepicker" data-date-format="dd-mm-yyyy">
                                            <input type="text"  name="staff_birthday" value="{{date('d-m-Y', strtotime($_object['staff_birthday']))}}" class="form-control ">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <div class="label-check col-sm-12">
                                                <div class=" col-sm-3" >
                                                    <input type="radio" name="is_active"  id="radio1_Opt4" value="1" @if($_object['is_active'] == '1') {{'checked'}} @endif >
                                                    <label for="radio1_Opt4">Active</label>
                                                </div>
                                                <div class=" col-sm-3">
                                                    <input type="radio" name="is_active" id="radio1_Opt5" value="0" @if($_object['is_active'] == '0') {{'checked'}} @endif>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <select class="form-control select2" name="group_id">
                                                ...
                                                <option value="2" >Nhóm quản lý</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 input-group">
                                            <textarea  class="form-control " name="staff_description" style="min-height: 100px"> {{$_object['staff_description']}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="staff_id"  value="{{$_object['staff_id']}}" />
                            </div>
                        </div>
                    </div>
                </div>
